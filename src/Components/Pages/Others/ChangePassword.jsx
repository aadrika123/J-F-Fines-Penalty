...
const ChangePassword = () => {
    ...
    const handleSubmit = (values) => {
        ...
        let body = {
            ...
            password: encryptPassword(formik.values.oldPassword), // 🔐 Encrypted using AES-256-CBC
            newPassword: encryptPassword(formik.values.newPassword), // 🔐 Encrypted using AES-256-CBC
        }
