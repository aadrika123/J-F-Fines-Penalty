...
const SideBar = (props) => {
  ...
  const [dropDown, setdropDown] = useState(
    getLocalStorageItem("dropDown") || false
  );
  const [dropName, setdropName] = useState(
    getLocalStorageItem("dropName") || ""
  );
    ...
    <>
      ...
      <header
        className={
          ...
          ` relative select-none transition-all duration-200 h-full text-${tcolor}-800 pt-2 border-r border-${tcolor}-200`
        }
      >
        {
          <div
              ...
              <div class={`mb-auto text-sm 2xl:text-base text-${tcolor}-800`}>
                ...
                <div class="text-center mb-4">
                  ...
                  >
                    ...
                    <span className="flex justify-center w-full uppercase text-xs font-semibold">
                        ...
                        <>
                          ...
                          >
                            ...
                            {item?.children?.length > 0 &&
                              dropName == item?.name && (
                                <ul
                                  class={`block rounded rounded-t-none top-full py-0.5 ltr:text-left rtl:text-right mb-4 bg-${mcolor}-200`}
                                >
