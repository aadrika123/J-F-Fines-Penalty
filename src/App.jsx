...
const UserMaster = lazy(() =>
  import("@/Components/Pages/FPComponents/UserMaster/UserMasterIndex")
);
const NewPassowd = lazy(() => import("@/Components/Pages/Others/NewPassowd"));
const CashVerificationIndex = lazy(() =>
  import(
    "@/Components/Pages/FPComponents/CashVerification/CashVerificationIndex"
  )
);
const FpPaymentDirect = lazy(() =>
  import("@/Components/Pages/FPComponents/FpPaymentDirect")
);
const FPTrackDirect = lazy(() =>
  import("@/Components/Pages/FPComponents/FPTrack/FPTrackDirect")
);
const FpChallan2Direct = lazy(() =>
  import("@/Components/Pages/FPComponents/FpPrint/FpChallan2Direct")
);
const FpReceiptDirect = lazy(() =>
  import("@/Components/Pages/FPComponents/FpPrint/FpReceiptDirect")
);
const BackButton = lazy(() => import("@/Components/Pages/Others/BackButton"));
const CitizenRoutes = lazy(() =>
  import("@/Components/Pages/Others/CitizenRoutes")
);
const CitizenIndex = lazy(() =>
  import("@/Components/Pages/FPComponents/Citizen/CitizenHome/CitizenIndex")
);
const EnforcementCell = lazy(() =>
  import("@/Components/Pages/FPComponents/Citizen/EnforcementCell")
);
const EnforcementOfficer = lazy(() =>
  import("@/Components/Pages/FPComponents/Citizen/EnforcementOfficer")
);
const CitizenViolationList = lazy(() =>
  import("@/Components/Pages/FPComponents/Citizen/CitizenViolationList")
);
...
function App() {
  ...
  const allRoutes = [
    ...
    // { path: "/transfer", element: <TransferPage /> },
    {
      path: "/transfer",
      element: (
        <Authentication hasContent={true} roles={["ADMIN"]}>
          {" "}
          <TransferPage />
        </Authentication>
      ),
    ...
    // { path: "/change-password", element: <ChangePassword /> },
    {
      ...
      element: (
        <Authentication
          hasContent={true}
          roles={["ADMIN", "JSK", "ENFORCEMENT CELL", "COMMITTEE MEMBER"]}
        >
          {" "}
          <ChangePassword />
        </Authentication>
    ...
    // { path: "/fp-workflow", element: <FpWorkflowEntry /> },
    {
      path: "/fp-workflow",
      element: (
        <Authentication hasContent={true} roles={["COMMITTEE MEMBER", "ADMIN"]}>
          {" "}
          <FpWorkflowEntry />
        </Authentication>
      ),
    ...
    // { path: "/fp-pay/:id", element: <FpPayment /> },
    {
      path: "/fp-pay/:id",
      element: (
        <Authentication hasContent={true} roles={["JSK"]}>
          {" "}
          <FpPayment />{" "}
        </Authentication>
      ),
    ...
    {
      path: "/fp-receipt/:tranNo",
      element: (
        <Authentication
          hasContent={true}
          roles={["JSK", "ADMIN", "COMMITTEE MEMBER", "ENFORCEMENT CELL"]}
        >
          {" "}
          <FpReceipt />{" "}
        </Authentication>
    ...
    // { path: "/challan-generated-report", element: <ChallanGeneratingReport /> },
    {
      ...
      element: (
        <Authentication hasContent={true} roles={["ENFORCEMENT CELL", "ADMIN"]}>
          {" "}
          <ChallanGeneratingReport />{" "}
        </Authentication>
      ),
    },
    ...
    // { path: "/cash-verification", element: <CashVerificationIndex /> },
    {
      ...
      element: (
        <Authentication
          hasContent={true}
          roles={["ENFORCEMENT CELL", "ADMIN", "ACCOUNTANT"]}
        >
          {" "}
          <CashVerificationIndex />{" "}
        </Authentication>
      ),
    },
        ...
        <Routes>
          ...
          <Route element={<CitizenRoutes />}>
            ...
            <Route element={<BackButton />}>
              <Route
                path="/search-challan/direct"
                element={<FPTrackDirect />}
              />
              <Route
                path="/enforcement-officer-list"
                element={<EnforcementOfficer />}
              />
              <Route
                path="/enforcement-cell-list"
                element={<EnforcementCell />}
              />
              <Route
                path="/violation-list"
                element={<CitizenViolationList />}
              />
              <Route
                path="/challan-show/:id/direct"
                element={<FpChallan2Direct />}
              />
              <Route path="/fp-pay/:id/direct" element={<FpPaymentDirect />} />
              <Route
                path="/payment-receipt/:tranNo/direct"
                element={<FpReceiptDirect />}
              />
            </Route>
